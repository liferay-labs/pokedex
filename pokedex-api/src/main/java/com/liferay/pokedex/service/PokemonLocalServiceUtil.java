...
/**
 * Provides the local service utility for Pokemon. This utility wraps
 * {@link com.liferay.pokedex.service.impl.PokemonLocalServiceImpl} and is the
 ...
 * @see com.liferay.pokedex.service.base.PokemonLocalServiceBaseImpl
 * @see com.liferay.pokedex.service.impl.PokemonLocalServiceImpl
 * @generated
 */
@ProviderType
public class PokemonLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.pokedex.service.impl.PokemonLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.pokedex.model.Pokemon createPokemon(long id) {
		return getService().createPokemon(id);
	}
	...
	*/
	public static com.liferay.pokedex.model.Pokemon deletePokemon(
		com.liferay.pokedex.model.Pokemon pokemon) {
		return getService().deletePokemon(pokemon);
	}
	...
	*/
	...
	public static com.liferay.pokedex.model.Pokemon fetchPokemon(long id) {
		return getService().fetchPokemon(id);
	}
	...
	*/
	public static com.liferay.pokedex.model.Pokemon fetchPokemonByUuidAndGroupId(
		java.lang.String uuid, long groupId) {
		return getService().fetchPokemonByUuidAndGroupId(uuid, groupId);
	}
	...
	* @throws PortalException if a pokemon with the primary key could not be found
	*/
	public static com.liferay.pokedex.model.Pokemon getPokemon(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getPokemon(id);
	}
	...
	*/
	public static com.liferay.pokedex.model.Pokemon getPokemonByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getPokemonByUuidAndGroupId(uuid, groupId);
	}
	...
	*/
	public static int getPokemonsCount() {
		return getService().getPokemonsCount();
	}
	...
	*/
	public static java.util.List<com.liferay.pokedex.model.Pokemon> getPokemonsByUuidAndCompanyId(
		java.lang.String uuid, long companyId) {
		return getService().getPokemonsByUuidAndCompanyId(uuid, companyId);
	}
	...
	*/
	public static java.util.List<com.liferay.pokedex.model.Pokemon> getPokemonsByUuidAndCompanyId(
		...
		return getService()
				   .getPokemonsByUuidAndCompanyId(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	*/
	...
	public static PokemonLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<PokemonLocalService, PokemonLocalService> _serviceTracker =
		ServiceTrackerFactory.open(PokemonLocalService.class);
}
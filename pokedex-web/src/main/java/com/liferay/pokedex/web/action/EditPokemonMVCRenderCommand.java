...
public class EditPokemonMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		try {
			pokemon = _pokemonLocalService.getPokemon(id);
		}
		...
		template.put("actionURL", getEditPokemonActionURL(renderResponse));
	...
	protected String getEditPokemonActionURL(RenderResponse renderResponse) {
